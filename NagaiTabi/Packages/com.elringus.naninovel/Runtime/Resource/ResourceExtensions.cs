...
namespace Naninovel
{
    ...
    public static class ResourceExtensions
    {
        ...
        /// When the path is specified, will only collect holders associated with the local resource path.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to retrieve object of a resource with the specified local path; returns false when
        ...
        /// <summary>
        /// Loads a resource with the specified full path. When holder is specified, will as well hold the resource.
        ...
        /// <summary>
        /// Loads a resource with the specified type and local path. When holder is specified, will as well hold
        ...
        /// <summary>
        /// Given full path of the specified resource starts with path prefix managed by this loader,
