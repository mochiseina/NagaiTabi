...
namespace Naninovel
{
    ...
    public static class Engine
    {
        ...
        /// <remarks>It's safe to access this property when the engine is not initialized and in editor.</remarks>
        ...
        /// <summary>
        /// Creates a new object, making it a child of the engine object and adding specified component type.
        /// </summary>
        /// <param name="options">Optional parameters.</param>
