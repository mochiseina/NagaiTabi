...
namespace Naninovel
{
    ...
    {
        /// <summary>
        /// Whether player currently has a track with the specified identifier.
        /// </summary>
        ...
        /// <summary>
        /// Returns managed track instance with the specified identifier; throws when not found.
        /// </summary>
        ...
        /// <summary>
        /// Returns managed track instance with the specified identifier; adds it when not found.
        /// </summary>
        ...
        /// The transient script is un-registered (removed) automatically by <see cref="IScriptManager"/> when it's
