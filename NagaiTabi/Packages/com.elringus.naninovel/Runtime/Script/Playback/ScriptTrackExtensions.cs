...
namespace Naninovel
{
    ...
    public static class ScriptTrackExtensions
    {
        ...
        /// <summary>
        /// Loads a script with specified local resource path and starts executing it from the specified playlist index.
        /// </summary>
        ...
        public static async Awaitable Executing (this IScriptTrack track, string scriptPath, int playlistIndex = 0)
        {
            await Engine.GetServiceOrErr<IScriptLoader>().Load(track.Id, scriptPath, playlistIndex);
        ...
        public static async Awaitable LoadAndPlayAtLine (this IScriptTrack track, string scriptPath, int lineIndex, int inlineIndex)
        {
            var script = (Script)await Engine.GetServiceOrErr<IScriptManager>().ScriptLoader.LoadOrErr(scriptPath, track);
        ...
        public static Awaitable ExecuteTransientCommand (this IScriptTrack track, string text, string name = null, AsyncToken token = default)
        {
